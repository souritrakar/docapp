...
export default class DocHome extends React.Component{
    constructor(props){
        super(props)
        this.state={
            cred:{}
    ...
    render(){
        return(
            <View style={styles.container}>
                <WavyHeader  customColor='green'  customStyles={styles.svgCurve} />
      <View style={styles.headerContainer}>
        <Text style={styles.headerText}>Welcome, Dr {this.state.cred.name}.</Text>
      </View>
